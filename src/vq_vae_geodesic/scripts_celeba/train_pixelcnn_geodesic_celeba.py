...
"""Train PixelCNN autoregressive prior on VAE + Geodesic quantized CelebA codes."""
def launch_train_pixelcnn(resume=False):
    ...
    train_loss_history = []
    val_loss_history = []
    checkpoint_path = checkpoint_dir('celeba') / "pixelcnn_geodesic_celeba.pt"
