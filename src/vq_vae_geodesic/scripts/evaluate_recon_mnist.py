import torch
import wandb
from vq_vae_geodesic.utils import set_seed, add_prefix_to_dict
...
def launch_evaluation():
    ...
    plot_reconstructions_comparison(orig_imgs, vae_recon, geodesic_recon, vqvae_recon, n_show=n_show, out_path=recons_dir() / 'reconstructions_comparison.png')
