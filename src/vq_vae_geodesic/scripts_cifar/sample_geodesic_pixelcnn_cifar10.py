"""
VAE+Geodesic: sample new discrete codes from trained PixelCNN and generate images (CIFAR-10).
...
def launch_sample_pixelcnn(n_samples=16, temperature=1.0):
    ...
    data_path = save_dir / f"geodesic_pixelcnn_samples_cifar10_t{temperature:.1f}.pt"
    grid_path = save_dir / f"geodesic_pixelcnn_samples_cifar10_grid_t{temperature:.1f}.png"
    ...
    save_generated_samples(
        ...
        data_path=data_path,
        grid_path=grid_path,
        grid_title=f"Geodesic PixelCNN Samples CIFAR-10 (T={temperature})",
        temperature=temperature
    )
