...
def launch_train(resume=False):
    ...
    # Build model
    model = build_vae_from_config(config.arch_params, dataset="cifar")
    ...
    val_loss_history = []
    val_recon_history = []
    checkpoint_path = checkpoint_dir('cifar10') / "vae_cifar10.pt"
    ...
    print("uv run -m vq_vae_geodesic.scripts.extract_cifar10_latents")
